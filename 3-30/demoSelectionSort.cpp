...
int main()
{
	...
	SelectionSort<int,IntCompare>(a_int, n_int);
	cout << "After SelectionSort: "; printA(a_int, n_int);
	
	cout << "A set of strings: "; printA(a_char, n_char);
	SelectionSort<char*,CharsCompare>(a_char, n_char);
	cout << "After SelectionSort: "; printA(a_char, n_char);
