...
int main()
{
	...
	BubbleSort<int,IntCompare>(a_int, n_int);
	cout << "After BubbleSort: "; printA(a_int, n_int);
	
	cout << "A set of strings: "; printA(a_char, n_char);
	BubbleSort<char*,CharsCompare>(a_char, n_char);
	cout << "After BubbleSort: "; printA(a_char, n_char);
